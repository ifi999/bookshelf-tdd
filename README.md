...
Book
1. 책 추가
 - 사용자는 새로운 책을 책장에 추가할 수 있어야 한다.
 - 책 제목, 저자, 고유 식별 번호, 구매일 등의 정보를 입력할 수 있어야 한다.
2. 책 검색
 - 사용자는 특정 책의 상세 정보를 조회할 수 있어야 한다.
 - 책의 위치, 저자 등의 정보를 상세하게 확인할 수 있어야 한다.
3. 책 정보 수정
 - 사용자는 책장의 정보를 수정할 수 있어야 한다.
 - 수정 가능한 정보로는 구매일, 카테고리 등이 있어야 한다.
4. 책 삭제
 - 사용자는 특정 책을 삭제할 수 있어야 한다.
 - 삭제하려는 책을 고를 수 있어야 한다.
```